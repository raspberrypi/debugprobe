...
bool    swd_read_dp(uint8_t adr, uint32_t *val);
bool    swd_write_dp(uint8_t adr, uint32_t val);
bool    swd_read_ap(uint32_t adr, uint32_t *val);
bool    swd_write_ap(uint32_t adr, uint32_t val);
bool    swd_read_word(uint32_t addr, uint32_t *val);
bool    swd_write_word(uint32_t addr, uint32_t val);
bool    swd_read_byte(uint32_t addr, uint8_t *val);
bool    swd_write_byte(uint32_t addr, uint8_t val);
bool    swd_read_memory(uint32_t address, uint8_t *data, uint32_t size);
bool    swd_write_memory(uint32_t address, uint8_t *data, uint32_t size);
