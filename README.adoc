...
## Details
### Known Devices
* RP2040 (and its flash "win w25q16jv")
* nRF52832/833/840
...
## Ideas
* hardware
** SWDDIR for external level shifter, should be high for TX 
   operation (compatible with SN74AVC(H)2T45)
** 7803 for power supply of target
** level shifter for sigrok
** is a direction switch required at all?  See TXS0108E: https://cdn.sparkfun.com/assets/1/8/1/e/2/txs0108e.pdf
